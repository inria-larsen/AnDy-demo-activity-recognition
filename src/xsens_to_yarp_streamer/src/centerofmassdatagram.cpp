...
/*! Constructor */
CenterOfMassDatagram::CenterOfMassDatagram(yarp::os::BufferedPort<yarp::os::Bottle> &port)
	: Datagram(port)
{
...
void CenterOfMassDatagram::publishData()
{
	...
	/*bottle.addString("C");*/
	bottle.addDouble(m_pos[0]);
	bottle.addDouble(m_pos[1]);
	bottle.addDouble(m_pos[2]);
