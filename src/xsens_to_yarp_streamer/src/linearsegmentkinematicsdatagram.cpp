...
/*! Constructor */
LinearSegmentKinematicsDatagram::LinearSegmentKinematicsDatagram(yarp::os::BufferedPort<yarp::os::Bottle> &port)
	: Datagram(port)
{
...
void LinearSegmentKinematicsDatagram::publishData()
{
  ...
  for (int i = 0; i < m_data.size(); i++)
  {
    ...
    bottle.addDouble(m_data.at(i).pos[0]);
    bottle.addDouble(m_data.at(i).pos[1]);
    bottle.addDouble(m_data.at(i).pos[2]);

    bottle.addDouble(m_data.at(i).velocity[0]);
    bottle.addDouble(m_data.at(i).velocity[1]);
    bottle.addDouble(m_data.at(i).velocity[2]);

    bottle.addDouble(m_data.at(i).acceleration[0]);
    bottle.addDouble(m_data.at(i).acceleration[1]);
    bottle.addDouble(m_data.at(i).acceleration[2]);
  }
  port.write();
}
